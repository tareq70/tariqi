...
{
    /// <inheritdoc />
    public partial class AddFullyDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformedUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuditLogs_AspNetUsers_PerformedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginAreaId = table.Column<int>(type: "int", nullable: false),
                    DestinationRegionId = table.Column<int>(type: "int", nullable: false),
                    DestinationAreaId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trips_Areas_DestinationAreaId",
                        column: x => x.DestinationAreaId,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trips_Areas_OriginAreaId",
                        column: x => x.OriginAreaId,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_PerformedUserId",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_DestinationAreaId",
                table: "Trips",
                column: "DestinationAreaId");

            migrationBuilder.CreateIndex(
                name: "IX_Trips_OriginAreaId",
                table: "Trips",
                column: "OriginAreaId");
